...
sub vcl_init {
  ...
  cluster.add_backend(client127_0_0_1_9001, 1);
  cluster.add_backend(client127_0_0_1_9002, 1);
  cluster.add_backend(client127_0_0_1_9003, 1);
  cluster.add_backend(client127_0_0_1_9004, 1);
}
